...
<head>
    ...
    <title>{{ $letter->reference_number }} — {{ $tower->name }}</title>
    <link rel="stylesheet" href="{{ asset('css/approval-letter.css') }}">
    <style>
        body.approval-letter-print-body {
            margin: 0;
            background: #eef2f0;
            font-family: system-ui, sans-serif;
        }
        .approval-letter-print-toolbar {
            position: sticky;
            top: 0;
            z-index: 10;
        ...
        .approval-letter-print-toolbar__inner {
            max-width: 210mm;
            margin: 0 auto;
            display: flex;
            align-items: center;
        ...
        .approval-letter-print-toolbar p {
            margin: 0;
            font-size: 14px;
            color: #374151;
        }
        .approval-letter-print-toolbar button {
            border: 0;
            border-radius: 10px;
            background: #1b4d3e;
            color: #fff;
        ...
        .approval-letter-print-toolbar button:hover {
            background: #14382c;
        }
        .approval-letter-print-page {
            margin: 24px auto;
