        ...
        <div class="relative flex flex-1 min-h-0">
            ...
            >
                @php
                    ...
                    if (Auth::user()->canTask('users.manage')) {
                    ...
                    if (Auth::user()->canTask('roles.manage')) {
                        $links[] = ['roles.index', 'app.nav.roles', 'roles.*', 'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4'];
                    }
                    if (Auth::user()->canTask('audit.view')) {
                    ...
                    if (Auth::user()->canTask('settings.manage')) {
