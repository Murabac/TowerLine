    ...
    <div class="p-4 lg:p-8 max-w-5xl">
        <div class="overflow-hidden rounded-3xl border border-brand/15 bg-gradient-to-br from-[#1B4D3E] via-[#246352] to-[#1B4D3E] px-6 py-8 sm:px-8 text-white">
            ...
            <div class="mt-6 flex flex-wrap gap-2">
                ...
                <a href="{{ route('guidelines') }}" target="_blank" rel="noopener" class="inline-flex items-center rounded-full bg-white/10 px-4 py-2 text-sm font-medium text-white ring-1 ring-white/25 hover:bg-white/20">{{ __('app.guidelines.window_label') }}</a>
                <a href="{{ route('apply.create') }}" class="inline-flex items-center rounded-full bg-white/10 px-4 py-2 text-sm font-medium text-white ring-1 ring-white/25 hover:bg-white/20">{{ __('app.apply.open', [], 'en') }}</a>
            </div>
        </div>
        ...
        <section class="mt-8">
            ...
            <div class="mt-3 grid gap-3 md:grid-cols-2">
                @foreach ([
                    ...
                    'section_head' => ['bg' => 'bg-violet-50', 'ring' => 'ring-violet-200', 'badge' => 'bg-violet-100 text-violet-800'],
