...
class Permissions
{
    ...
    public const TASKS = [
        ...
        'applications.view' => 'View site applications',
        'applications.assign' => 'Assign site applications',
        'applications.review' => 'Review site applications and record a site visit',
        'applications.concur' => 'Record Department Director concurrence',
        'applications.grant' => 'Grant or return a site application as Director General',
    ...
    public const SYSTEM_ROLES = [
        ...
        'section_head' => ['name' => 'Section Head', 'requires_regions' => false],
        'assigned_officer' => ['name' => 'Assigned officer', 'requires_regions' => false],
