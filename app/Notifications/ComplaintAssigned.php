...
class ComplaintAssigned extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('app.complaints.notify.assigned_subject', ['ref' => $this->complaint->reference_number]))
            ->line(__('app.complaints.notify.assigned_line', ['ref' => $this->complaint->reference_number]))
